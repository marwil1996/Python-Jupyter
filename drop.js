...
//var sql = "INSERT INTO customers (Name, Email) VALUES ('Steve Rogers', 'captamerica@gmail.com')";
	...
	//Make sure to do ORDER BY before LIMIT

	//var sql = "SELECT Email FROM customers ORDER BY ID DESC LIMIT 7";
	//con.query(sql, function(err, result) {
	//	if (err) throw err;
	//	console.log(result);
	//});

	//Drop Table - created new table to delete

	//var sql = "CREATE TABLE games (ID INT AUTO_INCREMENT PRIMARY KEY, Console VARCHAR(255))";
	//con.query(sql, function(err, result) {
	//	if (err) throw err;
	//	console.log("New table created!");
	//});

	//var sql = "DROP TABLE games";
	//con.query(sql, function(err, result){
	//	if (err) throw err;
